...
import com.testerhome.android.app.provider.base.BaseContentProvider;
import com.testerhome.android.app.provider.favorite.FavoriteColumns;

import java.util.Arrays;

public class TesterHomeProvider extends BaseContentProvider {
    private static final String TAG = TesterHomeProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "com.testerhome.android.app.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return TesterHomeSQLiteOpenHelper.getInstance(getContext());
    }
